...
//               className="w-full py-4 px-6 border border-transparent text-lg font-semibold rounded-xl text-white bg-secondary hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors duration-300 shadow-md hover:shadow-lg flex justify-center items-center"
//             >
//               Get Premium Now
//             </a>
//           </div>
...
export function PlansSection() {
  ...
  const handleGetPremium = () => {
    ...
    navigate("/user/subscription"); // If using React Router
    // OR use window.location.href = "/user/subscription" for regular links
  };
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12">
        ...
        {/* Right Side: Premium Plan Card */}
        <div className="lg:w-1/2 flex justify-center lg:justify-end">
          <div className="bg-white border border-gray-200 rounded-3xl shadow-xl p-8 max-w-sm w-full transform hover:scale-[1.02] transition-transform duration-300 ease-in-out">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-secondary mb-2">Premium Plan</h3>
              <p className="text-gray-500">For those who seek consistent, dedicated support.</p>
            </div>
